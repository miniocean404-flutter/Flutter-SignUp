...
class ClassicalFooterWidgetState extends State<ClassicalFooterWidget> with TickerProviderStateMixin<ClassicalFooterWidget> {
  // 是否到达触发加载距离
      ...
      children: <Widget>[
        Positioned(
          ...
          child: Container(
            ...
            child: SizedBox(
              height: isVertical ? widget.loadIndicatorExtent - 15 : double.infinity,
