...
class DragElementPhysics extends StatefulWidget {
  const DragElementPhysics({Key? key}) : super(key: key);

  @override
  State<DragElementPhysics> createState() => _DragElementPhysicsState();
}

class _DragElementPhysicsState extends State<DragElementPhysics> {
  @override
...
class _DraggableCardState extends State<DraggableCard> with SingleTickerProviderStateMixin {
  ...
  void _runAnimation(Offset velocity, Size size) {
    ...
    final simulation = SpringSimulation(_spring, 0.0, 1.0, _normalizeVelocity(velocity, size));
