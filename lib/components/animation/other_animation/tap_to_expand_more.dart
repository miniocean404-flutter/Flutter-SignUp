...
class TapToExpandMore extends StatefulWidget {
  const TapToExpandMore({Key? key}) : super(key: key);

  @override
  State<TapToExpandMore> createState() => _TapToExpandMoreState();
}

class _TapToExpandMoreState extends State<TapToExpandMore> {
  @override
...
class AnimCard extends StatefulWidget {
  ...
  const AnimCard(this.color, this.num, this.numEng, this.content, {Key? key}) : super(key: key);
      ...
      children: [
        ...
        Align(
          ...
          child: Container(
            ...
            child: Center(child: Icon(Icons.favorite, color: const Color(0xffFF6594).withOpacity(1.0), size: 70)),
          ),
        ),
      ],
    );
...
class CardItem extends StatelessWidget {
  ...
  const CardItem(this.color, this.num, this.numEng, this.content, this.onTap, {Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          boxShadow: [
            BoxShadow(color: const Color(0xffFF6594).withOpacity(0.2), blurRadius: 25),
          ],
