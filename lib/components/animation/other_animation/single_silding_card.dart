...
class SingleSildingCcard extends StatefulWidget {
  const SingleSildingCcard({Key? key}) : super(key: key);

  @override
  State<SingleSildingCcard> createState() => _SingleSildingCcardState();
}

class _SingleSildingCcardState extends State<SingleSildingCcard> {
  double _page = 10;
                    ...
                    double start = 20 +
                        max(
                            (boxConstraints.maxWidth - width * .75) -
                                ((boxConstraints.maxWidth - width * .75) / 2) * -currentPageValue * (pageLocation ? 9 : 1),
                            0.0);
