...
class RippleCorrugated extends StatefulWidget {
  const RippleCorrugated({Key? key}) : super(key: key);

  @override
  State<RippleCorrugated> createState() => _RippleCorrugatedState();
}

class _RippleCorrugatedState extends State<RippleCorrugated> with TickerProviderStateMixin {
...
class MyPainter extends CustomPainter {
  ...
  MyPainter(this.firstRippleRadius, this.firstRippleOpacity, this.firstRippleStrokeWidth, this.secondRippleRadius, this.secondRippleOpacity,
      this.secondRippleStrokeWidth, this.thirdRippleRadius, this.thirdRippleOpacity, this.thirdRippleStrokeWidth, this.centerCircleRadius);
