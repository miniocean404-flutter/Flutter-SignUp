...
class FloatSelectScaleBar extends StatefulWidget {
  const FloatSelectScaleBar({Key? key}) : super(key: key);

  @override
  State<FloatSelectScaleBar> createState() => FloatSelectScaleBarState();
}

class FloatSelectScaleBarState extends State<FloatSelectScaleBar> {
  var currentIndex = 0;
