...
class FloatItemBoxBar extends StatefulWidget {
  const FloatItemBoxBar({Key? key}) : super(key: key);

  @override
  State<FloatItemBoxBar> createState() => FloatItemBoxBarState();
}

class FloatItemBoxBarState extends State<FloatItemBoxBar> {
  var currentIndex = 0;
